    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                ...
                const sliderImages = document.querySelectorAll(".mainslider__image-ibg");
                const sliderDotts = document.querySelectorAll(".mainslider__dotts .swiper-pagination-bullet");
                ...
                if (document.querySelector(".products-slider__item")) new core(".products-slider__item", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                ...
                if (document.querySelector(".sliders-product")) {
                    let e = new core(".sliders-product__subslider", {
                        modules: [ Thumb ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 4,
                    ...
                    new core(".sliders-product__mainslider", {
                        modules: [ Thumb ],
                        observer: true,
        ...
        const searchButton = document.querySelector(".seacrh-page__title");
        ...
        for (let index = 0; index < checkboxCategories.length; index++) {
            ...
            checkboxCategory.addEventListener("change", (function(e) {
                ...
                const checkboxActiveCategory = document.querySelectorAll(".categories-search__checkbox._active");
                if (checkboxActiveCategory.length > 0) {
                    searchButton.classList.add("_categories");
                    const searchQuantity = searchButton.querySelector(".seacrh-page__quantity");
                    searchQuantity.innerHTML = searchQuantity.getAttribute("data-text") + " " + checkboxActiveCategory.length;
                } else searchButton.classList.remove("_categories");
            }));
        }
        if (isMobile.Android()) {
            let menuMods = document.querySelectorAll(".menu-page__mod>a");
            for (let index = 0; index < menuMods.length; index++) {
                const menuMod = menuMods[index];
                menuMod.addEventListener("click", (function(e) {
                    menuMod.parentElement.classList.toggle("_active");
                    e.preventDefault();
                }));
            }
        ...
        let menuMods = document.querySelectorAll(".menu-page__mod");
        for (let index = 0; index < menuMods.length; index++) {
            const menuMod = menuMods[index];
            menuMod.addEventListener("mouseenter", (function(e) {
                menuMod.classList.add("_active");
            }));
            menuMod.addEventListener("mouseleave", (function(e) {
                menuMod.classList.remove("_active");
            }));
        }
        window["FLS"] = true;
        isWebp();
